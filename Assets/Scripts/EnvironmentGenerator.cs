...
public class EnvironmentGenerator : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 1f)] private float _curveSmoothess = 0.5f;
    ...
    private void OnValidate()
    {
        ...
        for (int i = 0; i < _levelLength; i++)
        {
            ...
            if (i != 0 && i != _levelLength - 1)
            {
                ...
                _spriteShapeController.spline.SetLeftTangent(i, Vector3.left * _xMultiplier * _curveSmoothess);
                _spriteShapeController.spline.SetRightTangent(i, Vector3.right * _xMultiplier * _curveSmoothess);
            }
        }
